...
const Home: NextPage = () => {
    return (
        <>
            ...
            <Title
                title="LunaFlare's Projects"
                intro="I maintain a variety of free online projects for public use. They are listed here."
            />
                ...
                <div className="max-w-3xl mx-auto px-4 space-y-6">
                    <Category name="Pokémon Tectonic">
                        <CategoryIntro>
                            ...
                            <InlineLink url="https://www.tectonic-game.com/">Pokémon Tectonic</InlineLink>. In addition
                            to my contributions to the game itself, I have also created various standalone tools for
                        ...
                        <div className="space-y-6">
                            ...
                            <Item url="https://tectonic.alphakretin.com" title="Damage Calculator">
                                A damage calculator using the game&apos;s unique mechanics, stats, and formulae.
                                Currently a major work in progress. GitHub repository at{" "}
